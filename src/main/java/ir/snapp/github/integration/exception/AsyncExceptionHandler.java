...
public class AsyncExceptionHandler implements AsyncTaskExecutor, InitializingBean, DisposableBean {
    private final Logger log = LoggerFactory.getLogger(AsyncExceptionHandler.class);
    private final AsyncTaskExecutor executor;

    public AsyncExceptionHandler(AsyncTaskExecutor executor) {
